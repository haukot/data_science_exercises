...
class MCEnvironment:
    ...
    def initGraphs(self):
        ...
        self.clwindow = graph(x=0, y=0, width=x_width, height=y_height,
                        title="State Space", xtitle='Pos', ytitle='Vel',
                        xmax=0.6, xmin=-1.6, ymax=0.08, ymin=-0.08,
                        foreground=None, background=None)


        self.scene = canvas(x=self.clwindow.width, width=x_width, height=y_height,
                             title="Mountain Car Demo",visible=False)


        #self.clwindow.canvas.visible = False
