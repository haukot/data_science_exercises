...
class FARLBase:
    ...
    def __init__(self,Q,Environment,Action_Selector,gamma=1.0):
        ...
        # self.gtitle = label (canvas = self.LearningCurveGraph.canvas, pos=self.LearningCurveGraph.canvas.center,opacity=0, text="Learning Curve")
        self.LearningCurveGraph.canvas.visible= False
