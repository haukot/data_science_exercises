...
class CartPoleEnvironment:
    ...
    def InitGraphs(self):
        ...
        self.trwindow  = graph(x=x_width, y=0, width=x_width, height=y_height,
        ...
        self.awindow  = graph(x=x_width*2, y=0, width=150, height=y_height,
                        title="Actions", ytitle='Force',
                        xmin=0.0,xmax=2.0, ymax=1.0, ymin=-1.0,
                        foreground=color.black, background=color.white)


        #self.trwindow.canvas.visible =False
        #self.awindow.canvas.visible =False


        #state space
        #trajectory
        self.Gtrajectory = gcurve(graph=self.trwindow,color=color.blue)




        # classifiers
        self.clgraph = gdots(graph=self.awindow)


        #The cart is a Frame
        self.Frame_CartPole = frame(canvas=self.scene)
        ...
        self.top1        = box(canvas=self.scene,pos=(-6.5,1,0),height=4, width=1,material = materials.rough)
        self.top2        = box(canvas=self.scene,pos=(6.5,1,0),height=4, width=1,material = materials.rough)
    ...
    def PlotFunc(self,s,a,steps):
        ...
        self.awindow.canvas.visible =True
        self.trwindow.canvas.visible =True
        ...
        #self.awindow.canvas.title="Force applied: "+str(a)
    ...
    def ResetGraphs(self):
        ...
        self.Gtrajectory = gcurve(graph=self.trwindow,color=color.yellow)
