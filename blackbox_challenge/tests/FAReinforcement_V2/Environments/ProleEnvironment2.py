...
##            self.Pata.Direct(0.0,0.0)
    ...
    def initGraphs(self):
        ...
        self.scene = canvas(title='Pursuit and Evasion Predator/Protector/Prey System  -Dynamic Games Simulator-',x=0,y=0,
                width=800, height=600,
                center=(0,0,0), background=(1,1,1),
                autoscale=0,fullscreen=0)

        self.gtitle = label (canvas = self.scene, pos=(0,8), text="Information")
